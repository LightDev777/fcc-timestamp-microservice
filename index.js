...
var objUrl = url.parse(req.url, true);
 ...
 if(objUrl.pathname.length > 1) {
   ...
   var result = {
    ...
    html += '<p><code>https://fcc-timestamp-microservice-v1.herokuapp.com/December%2015,%202015</code></p>';
    html += '<p><code>https://fcc-timestamp-microservice-v1.herokuapp.com/1450137600</code></p>';
